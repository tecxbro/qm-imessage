...
- [`docs/imessage/architecture.md`](./docs/imessage/architecture.md) — prepared additive Photon-backed iMessage boundary; it is not a working integration
- [`docs/imessage/contracts.md`](./docs/imessage/contracts.md) — frozen transport, identity, operation, state, and evidence contracts for the iMessage lanes
- [`docs/imessage/workflow.md`](./docs/imessage/workflow.md) — immutable bases, original lane ownership, verification modes, and worktree preparation
